...
void Stem::display()
{
  ...
  for (i = 0; i < X.size(); i++) {
    ...
    Vertex v1 = {current + width / 2, height, 0, graph_color.r, graph_color.g, graph_color.b, graph_color.a};
    Vertex v2 = {current + width / 2, -0.8, 0, graph_color.r, graph_color.g, graph_color.b, graph_color.a};
